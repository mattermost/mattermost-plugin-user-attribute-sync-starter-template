...
ifneq ($(HAS_SERVER),)
	...
	mockgen -destination=server/command/mocks/mock_commands.go -package=mocks github.com/mattermost/user-attribute-sync-starter-template/server/command Command
endif
